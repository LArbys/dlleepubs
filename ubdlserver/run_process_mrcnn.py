...
class mrcnn(ds_project_base):
    ...
    def process_newruns(self):
        ...
        for x in results:
            ...
            ubmrcnnout = dbdir + "/" + self._outfile_format%("ubmrcnn-noinfill-larcv-%s"%(self._runtable),run,subrun)
...
PORT={}
BROKER={}
LOGFILE={}/log_mrcnn_{}_{}_{}.txt

ENVSETUP="cd $UBDL_DIR && source setenv.sh && source configure.sh && cd ublarcvserver && source configure.sh"
COMMAND="start_ublarcvserver_ubmrcnn_client.py -l $LOGFILE -d tcp://$BROKER:$PORT -i $SUPERA_INPUTPATH -o $UBMRCNN_OUTFILE"
