...
class likelihood_reco(ds_project_base):
    ...
    def process_newruns(self):
        ...
        for x in results:
            ...
            tagger_lcv_input  = os.path.join(inputdbdir0,self._file_format%("taggeroutv2-larcv",run,subrun))
            tagger_lcv_input += ".root"

            #tagger_ll_input  = os.path.join(inputdbdir0,self._file_format%("taggerout-larlite",run,subrun))
            tagger_ll_input  = os.path.join(inputdbdir0,self._file_format%("taggeroutv2-larlite",run,subrun))
