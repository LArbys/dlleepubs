...
class nueid_reco(ds_project_base):
    ...
    def get_resource(self):
        ...
        self._autoencodercfg         = os.path.join(CFG_DIR,"network",str(resource['AUTOENCODERCFG']))
    ...
    def process_newruns(self):
        ...
        for x in results:
            ...
            stat,out = commands.getstatusoutput("scp -r %s %s" % (self._autoencodercfg,workdir))
            autoencodercfg = os.path.join(workdir,os.path.basename(self._autoencodercfg))
            ...
            run_data = run_data.replace("EEE",os.path.basename(autoencodercfg))
    ...
    def validate(self):
        ...
        for x in results:
            ...
            # link
            ana = os.path.join(outdbdir,"autoencoder_out_%d.root" % jobtag)
